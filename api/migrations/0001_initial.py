# Generated by Django 2.2 on 2019-05-19 13:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.TextField(help_text='Текст задачи, включая входные и выходные данные')),
                ('efforts_available', models.IntegerField(default=5)),
                ('picture', easy_thumbnails.fields.ThumbnailerImageField(blank=True, null=True, upload_to='images/avatars')),
